...
export default function CTASection() {
  return (
    <section className="py-16 sm:py-24 bg-gradient-to-br from-[#000000] via-[#0a0f14] to-[#000000] relative overflow-hidden">
      ...
      <Container>
        ...
        >
          ...
          <p className="text-lg text-[#b8c5d0] mb-10 max-w-2xl mx-auto leading-relaxed">
            Join industry leaders using SubFusion AI to monitor offshore windfarms, telecom cables, and maritime infrastructure. Get a personalized demo and see your data in action.
          </p>
          ...
          {/* Trust Indicators */}
          <div className="mt-12 pt-8 border-t border-[#141a21]">
